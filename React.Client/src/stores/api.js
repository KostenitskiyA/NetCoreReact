...
export const GET_TODOS_BY_ACCOUNT_API = BASE_URL + TODO_CONTROLLER + "/{accountId}/todos";
export const GET_TODOS_BY_GROUP_API = BASE_URL + TODO_CONTROLLER + "/{groupId}/todos";
